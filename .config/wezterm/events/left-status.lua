...
-- peach pill keeps its dark label in both modes (peach is light enough to
-- carry dark text on a light theme too); only the glass semicircle glyph
-- needs a darker peach on light themes so it doesn't vanish.
local colors = {
   default = { bg = '#fab387', fg = '#1c1b19' },
   scircle = { bg = tokens.glass, fg = tokens.light and '#b35a00' or '#fab387' },
}
