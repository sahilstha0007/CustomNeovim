...
-- pick(dark, light): dark values match the old mocha chrome; light values are
-- their latte relatives (dark enough to read on a light tab bar).
...
-- stylua: ignore
local colors = {
   label_text   = { fg = tokens.fg },
   icon_default = { fg = tokens.accent },
   icon_wsl     = { fg = pick('#FAB387', '#b35a00') },
   icon_ssh     = { fg = pick('#F38BA8', '#c0204a') },
   icon_unix    = { fg = pick('#CBA6F7', '#6a4fc4') },
}
